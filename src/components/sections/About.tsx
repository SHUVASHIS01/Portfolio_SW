      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-12 lg:grid-cols-12 items-start">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              {FACTS.map((fact) => (
                <div key={fact.label} className="glass-soft rounded-2xl px-4 py-3 select-none">
                  <div className="text-[0.7rem] uppercase tracking-wide text-white font-semibold">
                    {fact.label}
                  </div>
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <div className="space-y-5 text-base sm:text-[1.05rem] leading-relaxed text-white">
              <p>
                ...
                return (
                  <div key={s.title} className="card-hover glass h-full rounded-2xl p-5 flex flex-col justify-between">
                    <div>
                      ...
                      <p className="mt-2 text-xs sm:text-sm leading-relaxed text-white">{s.desc}</p>
                    </div>
                  </div>
                );
              })}
