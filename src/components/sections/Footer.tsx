          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <span className="block text-[11px] text-white mt-1.5 uppercase tracking-wider">MERN · AI · Systems</span>
              </div>
            </div>
              ...
              {NAV_LINKS.map((link) => (
                <li key={link.id}>
                  <button
                    ...
                    className="text-sm font-medium text-white hover:text-accent transition-colors cursor-pointer"
                  >
                    {link.label}
                  </button>
                </li>
      ...
      <div className="relative border-t border-white/5 bg-black/20 overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 relative z-10 flex flex-col sm:flex-row items-center justify-between gap-4 py-8">
          ...
          <button
            ...
            className="flex items-center gap-2 text-xs font-semibold text-white hover:text-white transition-colors cursor-pointer"
          >
